...
namespace SampleCode
{
    ...
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        // This is where toms code starts
        ...
        public void imageSelection(int topLeft, int topRight, int bottomLeft, int bottomRight, RectangleViewModel sender)
        {

            sender.imageSelectionDeletion(topLeft, topRight, bottomLeft, bottomRight);


        }
        public String imageSelectionCopy(int topLeft, int topRight, int bottomLeft, int bottomRight, RectangleViewModel sender)
        {

            string newSelection = sender.imageSelectionRetrivial(topLeft, topRight, bottomLeft, bottomRight);

            return newSelection;
        }

        // This is the end of toms code        
